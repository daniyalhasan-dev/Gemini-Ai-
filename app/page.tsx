    ...
    <main className="min-h-screen bg-[#08090d] text-white">
      ...
      <nav className="relative z-10 flex h-16 items-center justify-between border-b border-white/[0.07] px-5 md:px-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="rounded-lg border border-white/10 px-3 py-2 text-xs text-white/60">
            New Chat
          </button>
        </div>
      </nav>
        ...
        <div className="mx-auto flex w-full max-w-4xl flex-1 flex-col justify-center px-5 py-12 md:px-8">
          ...
          <div className="mb-10">
            ...
            <p className="mt-5 max-w-xl text-sm leading-6 text-white/35">
              Ask questions, explore ideas, write content, or solve
              problems with your AI assistant.
            </p>
          </div>
        </div>
          ...
          <div className="mx-auto max-w-4xl">
            ...
            <div className="overflow-hidden rounded-[20px] border border-white/[0.10] bg-[#101117] shadow-2xl shadow-black/30">
              ...
              <textarea
                ...
                rows={3}
                className="w-full resize-none bg-transparent px-5 pt-5 text-sm leading-6 text-white outline-none placeholder:text-white/25"
              />
              ...
              <div className="flex items-center justify-between px-4 pb-4">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button className="flex h-8 w-8 items-center justify-center rounded-lg text-lg text-white/30">
                    +
                  </button>

                  <button className="rounded-lg px-2 py-1.5 text-xs text-white/30">
                    Attach
                  </button>

                </div>

                <button className="flex h-9 w-9 items-center justify-center rounded-xl bg-white text-black">
                  ↑
                </button>
